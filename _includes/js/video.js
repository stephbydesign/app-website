...
$('.btn-open').on ('click', function () {
  ...
  /*
    .get() returns the native Javascript element to for us to access when using JQuery we don't have access to the original HTML elements directly, we are using JQuery to manipulate them. Example:
